...
- Reads Telegram window/accessibility state and Teams/Outlook notification-area accessibility labels explicitly; it does not pretend that Windows exposes a universal cross-application badge API.
